...
Для проверки работоспособности и исправности сервиса были написаны тесты (папка `tests`). Они используют отдельную среду и собираются с помощью отдельного Dockerfile.
...
* Для хранения отсутствия даты слияния пул реквеста используется нулевое значение time.Time (00:00:00 1 января 1 года)
